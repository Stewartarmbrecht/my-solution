...
export const useMedia = jest.fn().mockReturnValue({ gtMd: true });
...
export const Info = ({ color, testID }: { color: string, testID: string }) => <LocalText testID={testID}>Info</LocalText>;
...
export const H3 = ({ children }: { children: React.ReactNode }) => <LocalText>{children}</LocalText>;
export const Separator = jest.fn();
export const Text = ({ children }: { children: React.ReactNode }) => <LocalText>{children}</LocalText>;
